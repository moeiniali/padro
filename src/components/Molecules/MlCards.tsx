...
const MlCards: React.FC<MyComponentProps> = ({ value, Element, href, onClick,
   ...
   children: (
    <div className='w-full h-44 flex flex-row bg-[#F6F7F9] justify-between items-center'>
     ...
     <Col dir='ltr' className='w-auto h-full  text-left p-2 flex flex-col flex-wrap gap-4'>
      <AtomText Element="ip" color='#7E838F' size="14px" weight='400' children="Ip Address" value={IpAddressVal} />
